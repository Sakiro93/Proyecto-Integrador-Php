<nav class="navbar navbar-blue navbar-fixed-top" role="navigation" style="background: #3f51b5">
    ...
    <div class="navbar-header">
        <div class="left_col">
            <div class="col-lg-12">
                <div class="col-lg-3" >
                    <img class="img-rounded logomain" width="170px" height="50px" src="../../static/img/menu/logomainblanco.png" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right" style="margin-right:1%">
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                        class="glyphicon glyphicon-user"></span> <?= ucwords($user->login) ?><b class="caret"></b></a>
                <ul class="dropdown-menu">
